...
export function SiteHeader() {
  ...
  return <header className="site-header"><div className="shell header-inner">
    <Link href="/" className="brand" aria-label="中国历史学习网首页"><img src={`${base}/assets/logo.png`} width="43" height="43" alt="" /><span>中国历史学习网<small>CHINESE HISTORY LEARNING NETWORK</small></span></Link>
