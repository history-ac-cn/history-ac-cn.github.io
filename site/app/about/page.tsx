  ...
  return <main id="main" className="shell inner-page about-page">
    ...
    <div className="about-layout">
      ...
      <div className="about-body">
        ...
        <section>
          <h2>本站往事</h2>
          <p>在原站点运行了两三年之后，阿里云服务器价格突然大幅上涨了二十多倍，原先的网站未能继续保留，服务器上的内容也随之丢失。好在，Internet Archive 保存下了它曾经的样子。</p>
          <a className="text-link" style={{ marginBottom: 20 }} href={archiveUrl} target="_blank" rel="noreferrer">看看网站在 Internet Archive 存档里的模样 <ArrowUpRight size={15}/></a>
