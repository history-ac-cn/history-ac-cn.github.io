...
export default function Home() {
  ...
  return <main id="main">
    ...
    <section className="shell chronicle-banner"><div className="chronicle-years" aria-hidden="true">1949<span>—</span>2009</div><div><span className="eyebrow">THE CHRONICLES</span><h2>以年为序，与历史相遇。</h2><p><PreferredWrap first="翻阅中华人民共和国大事记，" second="在具体的日子里，看见时代的变迁。"/></p><Link className="text-link" href={categoryHref('大事记')}>翻阅大事记 <ArrowRight size={17}/></Link></div><Clock3 size={25} strokeWidth={1}/></section>
  </main>;
}
